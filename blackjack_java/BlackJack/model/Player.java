...
public class Player {
  ...
  private java.util.ArrayList<ICardDealtObserver> m_subscribers;
  protected final int g_maxScore = 21;

  public Player()
  {
    m_hand = new LinkedList<Card>();
    m_subscribers = new java.util.ArrayList<ICardDealtObserver>();
  }
  ...
  public void InformSubscribers(){
	  for(ICardDealtObserver a_subscriber : m_subscribers){
